...
function AjouterPoste()
{
  try
  {
    ...
    if(!empty($data->libelle))
    {
      ...
      $cat = new DtoPoste(array());
      $cat->setLibelle($data->libelle);
      
      // create the product
      if($poste->creerPoste($cat))
      {
...
function SupprimerPoste()
{
  try
  {
    ...
    if($poste->supprimerPoste($data->id))
    {
      // set response code - 200 ok
      http_response_code(200);
